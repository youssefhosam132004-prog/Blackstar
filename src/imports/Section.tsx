import svgPaths from "./svg-ktwi3m8apt";
...
function RolesListItemTextText({ text, additionalClassNames = "" }: RolesListItemTextTextProps) {
  return (
    <div className={clsx("absolute h-[23.4px] left-0", additionalClassNames)}>
...
function ParagraphText({ text, additionalClassNames = "" }: ParagraphTextProps) {
  return (
    <div className={clsx("absolute content-stretch flex h-[27.717px] items-start", additionalClassNames)}>
