...
export function GarmentFactoryAnalytics() {
  ...
  const kpis = [
    { label: 'Active Orders', value: 27, change: '+12%', trend: 'up' },
    { label: 'Completed Orders', value: 184, change: '+8%', trend: 'up' },
    { label: 'Avg Delivery Time', value: '6.2 Days', change: '-0.8 Days', trend: 'down' },
    { label: 'Black Star Rating', value: '★ 0.82', change: '+0.04', trend: 'up' },
  ];

  const qualityMetrics = [
    { label: 'Quality Score', value: 88, unit: '%' },
    { label: 'Rework Rate', value: 3.4, unit: '%' },
    { label: 'Disputes', value: 2, unit: 'Open' },
  ];

  const ratingDimensions = [
    { label: 'Quality', value: 0.87, percentage: 87 },
    { label: 'Delivery Time', value: 0.81, percentage: 81 },
    { label: 'Communication', value: 0.89, percentage: 89 },
    { label: 'Volume Capacity', value: 0.85, percentage: 85 },
  ];
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="mb-20">
          ...
          <div className="border border-[#E5E7EB] p-8 mb-8">
            <h3 className="text-lg font-medium text-[#0B0D10] mb-6">Orders Over Time</h3>
            <div className="h-64 flex items-end justify-between gap-2">
              {[45, 52, 48, 61, 58, 67, 64, 71, 68, 75, 82, 78].map((height, i) => (
          ...
          <div className="border border-[#E5E7EB] p-8">
            ...
            <div className="flex items-center gap-6 mb-4">
              <div className="text-5xl font-bold text-[#0B0D10]">92%</div>
              <div className="flex items-center gap-2 text-[#16a34a]">
                <TrendingUp className="w-5 h-5" />
                <span className="text-sm">+3% from last period</span>
              </div>
            </div>
            <div className="h-4 bg-[#E5E7EB] rounded-full overflow-hidden">
              <div className="h-full bg-[#16a34a] transition-all duration-1000" style={{ width: '92%' }} />
            </div>
            <p className="text-xs text-[#9CA3AF] mt-3">
              Tracks bulk order timeline adherence across all production lines
            </p>
          </div>
        </div>
            ...
            {qualityMetrics.map((metric, index) => (
              ...
              >
                ...
                {metric.label === 'Rework Rate' && (
                  <p className="text-xs text-[#9CA3AF] mt-3">Lower = better professionalism</p>
                )}
              </div>
            ))}
          </div>
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border border-[#E5E7EB] p-8">
              ...
              <div className="text-5xl font-bold text-[#0B0D10] mb-4">74%</div>
              <div className="h-4 bg-[#E5E7EB] rounded-full overflow-hidden mb-3">
                <div className="h-full bg-[#16a34a] transition-all duration-1000" style={{ width: '74%' }} />
              </div>
              <p className="text-xs text-[#9CA3AF]">
                Optimal range: 60-85% • Current status: <span className="text-[#16a34a]">Optimal</span>
              </p>
            </div>
            ...
            <div className="border border-[#E5E7EB] p-8">
              ...
              <div className="space-y-3">
                {[
                  { name: 'Cotton Fleece', percentage: 42 },
                  { name: 'Denim', percentage: 28 },
                  { name: 'Jersey Knit', percentage: 18 },
                ].map((material) => (
                  <div key={material.name}>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm text-[#0B0D10]">{material.name}</span>
                      <span className="text-xs text-[#9CA3AF]">{material.percentage}%</span>
                    </div>
        ...
        <div className="mb-20">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-[#E6C36A] bg-[#E6C36A]/5 p-6 flex items-start gap-4">
              ...
              <div>
                <p className="text-[#0B0D10] font-medium mb-1">
                  Quality score improved after last 10 orders.
                </p>
                <p className="text-sm text-[#9CA3AF]">
                  Your bulk production consistency is strengthening client trust.
                </p>
              </div>
            </div>
            ...
            <div className="border-l-4 border-[#7A0F0F] bg-[#7A0F0F]/5 p-6 flex items-start gap-4">
              ...
              <div>
                <p className="text-[#0B0D10] font-medium mb-1">
                  Your delivery time increased last week.
                </p>
                <p className="text-sm text-[#9CA3AF]">
                  Consider adjusting capacity or timelines to maintain performance.
                </p>
              </div>
            </div>
          </div>
